...
import C, { BladesActorType, Tag, Playbook, BladesNoticeType, BladesItemType, ActionTrait, PrereqType, AdvancementPoint, Randomizers, Factor } from "./core/constants.js";
...
class BladesActor extends Actor {
        ...
        if (this instanceof BladesCrew) {
            ...
            this.members.forEach((member) => {
                if (member.primaryUser?.id) {
                    BladesDirector.getInstance().pushNotice_SocketCall(member.primaryUser?.id, {
    ...
    async advanceAttribute(attribute) {
        ...
        BladesDirector.getInstance().pushNotice_SocketCall(this.primaryUser.id, {
