...
export class BladesItem extends Item {
    ...
    prepareData() {
        ...
        if (item_data.type === "faction") {
            if (!data.goal_1_clock_value) {
                data.goal_1_clock_value = 0;
            }
            if (data.goal_1_clock_max === 0) {
                data.goal_1_clock_max = 4;
            }
            if (!data.goal_2_clock_value) {
                data.goal_2_clock_value = 0;
            }
            if (data.goal_2_clock_max === 0) {
                data.goal_2_clock_max = 4;
            }
