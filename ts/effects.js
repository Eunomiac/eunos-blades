...
export function onManageActiveEffect(event, owner) {
	...
	switch ( a.dataset.action ) {
		case "create":owner.createEmbeddedDocuments("ActiveEffect", [{
			"label": "New Effect",
...
export function prepareActiveEffectCategories(effects) {
	...
	for ( const e of effects ) {
		...
		if ( e.data.disabled ) {categories.inactive.effects.push(e)} else if ( e.isTemporary ) {categories.temporary.effects.push(e)} else {categories.passive.effects.push(e)}
	}
	return categories;
}