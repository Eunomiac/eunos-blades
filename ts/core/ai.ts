...
class BladesAI {
   ...
   */
  constructor(systemMessage: string, examplePrompts: Array<Record<"human"|"ai", string>>, config: BladesAI.Config = {}) {
   ...
   */
  async query(prompt: string, modelMod?: number, extendedContext = false) {
...
export const PROMPTS: Record<
  ...
  {
    system: string,
    examples?: Array<Record<"human"|"ai", string>>
  }
> = {
