...
//   get subActors(): Array<BladesActorOfType<"ANY">> {
//     return Object.keys(this.system.subactors)
//       .map((id) => this.getSubActor(id))
//       .filter((subActor): subActor is BladesActorOfType<"ANY"> => Boolean(subActor));
//   }
//   get activeSubActors(): Array<BladesActorOfType<"ANY">> { return this.subActors.filter((subActor) => !subActor.hasTag(Tag.System.Archived)) }
//   get archivedSubActors(): Array<BladesActorOfType<"ANY">> { return this.subActors.filter((subActor) => subActor.hasTag(Tag.System.Archived)) }

//   checkActorPrereqs(actor: BladesActorOfType<"ANY">): boolean {

//     /* Implement any prerequisite checks for embedding actors */

//     return true;
//   }
//   private processEmbeddedActorMatches(globalActors: Array<BladesActorOfType<"ANY">>) {
...
//   getDialogActors(category: SelectionCategory): Record<string, Array<BladesActorOfType<"ANY">>> | false {

//     /* **** NEED TO FILTER OUT ACTORS PLAYER DOESN'T HAVE PERMISSION TO SEE **** */

//     const dialogData: Record<string, Array<BladesActorOfType<"ANY">>> = {};
...
//     }
//     let focusSubActor: BladesActorOfType<"ANY"> | undefined;
...
//   getSubActor(actorRef: ActorRef): BladesActorOfType<"ANY"> | undefined {
//     const actor = BladesActor.Get(actorRef);
...
//     );
//     actor.parentActor = this as BladesActorOfType<"ANY">;
//     return actor;
//   }
...
//   parentActor?: BladesActorOfType<"ANY">;
