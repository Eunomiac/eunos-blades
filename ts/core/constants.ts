const C = {
	...
	Encumbrance: {
		loadLevel: {
			"options": {"BITD.Light":"BITD.Light", "BITD.Normal":"BITD.Normal", "BITD.Heavy":"BITD.Heavy"},
			"default": ["BITD.Light",
															"BITD.Light",
															"BITD.Light",
															"BITD.Light",
	...
	ClassTagLines: {
		...
		Ghost: "A Disembodied Spirit, Craving Vengeance",
		Hull: "A Spirit Animating a Spark-Craft Frame",
		Vampire: "A Spirit Animating an Undead Body"
	}
};
